...
# Lista dos volumes
volume = []
# Lista dos volumes financeiros
volume_real = []
# Lista dos ranges
range = []
# Lista dos ranges dos corpos
body_range = []
# Lista dos percentuais dos corpos
body_percentual = []
# Lista das sombras acima
top_tail = []
# Lista das sombras abaixo
bottom_tail = []
# Lista das tendencias das barras
trend_bar = []
    ...
    for rate in rates:
        ...
        bar = Bar(rate)
# Obtem a lista das horas
time.append(bar.datetime)
# Obtem a lista das datas
date.append(bar.date)
# Obtem a lista das aberturas
open.append(bar.open)
# Obtem a lista das máximass
open.append(bar.high)
# Obtem a lista das mínimas
open.append(bar.low)
# Obtem a lista dos fechamentos
open.append(bar.close)
